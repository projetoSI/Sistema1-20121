...
public class TestaClasseData {
	...
	public void testaDataAtual(){
		assertEquals("07/04/2012", data.getDataAtual());
	}
	...
	public void testaDataValida(){
		...
		assertFalse(data.dataValida(null, "05", "2012"));
		
		//Testa a aceitacao do mes
		assertFalse(data.dataValida("23", "00", "2012"));
		assertFalse(data.dataValida("23", "13", "2013"));
		assertFalse(data.dataValida("23", "32", "2012"));
		assertFalse(data.dataValida("23", "Pablo", "2012"));
		assertFalse(data.dataValida("23", "", "2012"));
		assertFalse(data.dataValida("23", null, "2012"));
		
		//Testa a aceitacao do ano
		assertFalse(data.dataValida("23", "04", "2011"));
		assertFalse(data.dataValida("23", "04", "Pablo"));
		assertFalse(data.dataValida("23", "04", ""));
		assertFalse(data.dataValida("23", "04", null));
		...
		assertFalse(data.dataValida("", "", "2013"));
		assertFalse(data.dataValida("", "05", ""));
		assertFalse(data.dataValida("05", "", ""));
		assertFalse(data.dataValida(null, null, null));
		assertFalse(data.dataValida(null, null, "2013"));
		assertFalse(data.dataValida(null, "05", null));
		assertFalse(data.dataValida("03", null, null));
		assertFalse(data.dataValida("Pablo", "Pablo", "Pablo"));
		assertFalse(data.dataValida("Pablo", "Pablo", "2012"));
		assertFalse(data.dataValida("Pablo", "05", "Pablo"));
		assertFalse(data.dataValida("05", "Pablo", "Pablo"));
		assertFalse(data.dataValida("!@#$%", "!@#$%", "!@#$%"));

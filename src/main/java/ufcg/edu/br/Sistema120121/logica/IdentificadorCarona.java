...
/**
 * Objeto responsável por identificar um objeto carona.
 * 
 */
public class IdentificadorCarona {
	 ...
	 */
	public String getHoraCarona() {
		return horaCarona.getHoras();
	}
	 ...
	 * @return true - para o caso dos identificadores serem iguais. false - para
	 *         o caso dos identificadores não serem iguais.
	 */
	@Override
	 ...
	 * 
	 * @return O id em forma de String.
	 */
	@Override

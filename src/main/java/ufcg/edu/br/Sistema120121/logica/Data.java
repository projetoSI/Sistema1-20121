...
/**
 * Classe data, responsável por gerenciamento de datas no sistema.
 * 
 */
public class Data {
	...
	public Data(String data) throws DateErrorException {
		if (dataValida(data)) {
			...
			throw new DateErrorException("Data inválida");
	 ...
	 * @return true - caso o formato esteja correto. false - caso o formato não
	 *         esteja correto.
	 */
	public boolean dataValida(String data) {
		...
		if (data.isEmpty() || data == null)
			return false;
		else if (!(verificaMeses31(dia, mes)) || !(verificaMeses30(dia, mes))
				|| !(verificaFevereiro(dia, mes, ano))
	 ...
	 * @param mes
	 *            O mes.
	 * @return true - caso esteja correto. false - caso não esteja correto.
	 */
	public boolean verificaMeses31(String dia, String mes) {
		if (((mes.equals("01")) || (mes.equals("03")) || (mes.equals("05"))
				|| (mes.equals("07")) || (mes.equals("08"))
				|| (mes.equals("10")) || (mes.equals("12")))
				&& ((Integer.parseInt(dia) > 31) || Integer.parseInt(dia) <= 0))
			return false;
		return true;
	}
	...
	public boolean verificaMeses30(String dia, String mes) {
		if (((mes.equals("04")) || (mes.equals("06")) || (mes.equals("09")) || (mes
				.equals("11")))
				&& ((Integer.parseInt(dia) > 30) || (Integer.parseInt(dia) <= 0)))
			return false;
		return true;
	}
	...
	public boolean verificaFevereiro(String dia, String mes, String ano) {
		...
		if (mes.equals("02")) {
			if (calendario.isLeapYear(Integer.parseInt(ano))
					&& ((Integer.parseInt(dia) > 29 && Integer.parseInt(dia) <= 0))
					|| (!(calendario.isLeapYear(Integer.parseInt(ano))) && ((Integer
							.parseInt(dia) > 28 || Integer.parseInt(dia) <= 0))))
				return false;
		}
		return true;
	}
	...
	public String getDataAtual() {
		...
		SimpleDateFormat formatador = new SimpleDateFormat(
				"dd'/'MM'/'yyyy' - 'HH':'mm'h'", local);
		String dataAtual = formatador.format(calendario.getTime()).substring(0,
				10);
		return dataAtual;
	}
}